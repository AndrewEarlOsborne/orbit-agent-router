...
class TestTransformationRegistry:
    ...
    def test_get_nonexistent_transform(self):
...
class TestResourceManager:
    ...
    def test_generate_output_uri_copy_mode(self):
    ...
    def test_generate_output_uri_inplace_mode(self):
...
class TestTransformContext:
    ...
    def test_context_new_ref_id_copy_mode(self):
    ...
    def test_context_same_ref_id_inplace_mode(self):
...
class TestDecorator:
    ...
    def test_decorator_registers_transformation(self):
    ...
    def test_decorator_adds_metadata(self):
        ...
        async def test_transform_metadata(resource_uri: str, in_place: bool = False):
            return {"type": "text", "text": "Test"}
...
class TestCSVTransforms:
    ...
    @pytest.mark.asyncio
    async def test_count_csv_import(self):
    ...
    @pytest.mark.asyncio
    async def test_filter_csv_import(self):
    ...
    @pytest.mark.asyncio
    async def test_select_csv_import(self):
    ...
    @pytest.mark.asyncio
    async def test_rename_csv_import(self):
    ...
    @pytest.mark.asyncio
    async def test_group_by_csv_import(self):
...
class TestIntegration:
    ...
    def test_end_to_end_decorator_registration(self):
